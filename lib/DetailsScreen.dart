...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  List<Color> colors = [
    kPrimaryColor,
    const Color.fromARGB(255, 243, 60, 47),
    Colors.blue,
  ];
              ...
              children: [
                Hero(
                  tag: widget.tags == true
                      ? "RecommendedFurnituresImage${widget.index}"
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Kane X Profesional Gaming Chair",
                      style: TextStyle(
                        fontSize: 30.0,
                        fontWeight: FontWeight.bold,
                      ),
                    ...
                    SizedBox(height: 8.0),
                    Text(
                      "High quality premium furniture, strong and durable materials accompanied by a modern and minimalist design.",
                      style: TextStyle(
                        color: Colors.grey,
                        fontSize: 16.0,
                        fontWeight: FontWeight.bold,
